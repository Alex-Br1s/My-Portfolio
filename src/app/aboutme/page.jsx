...
const AboutMe = () => {
  return(
    ...
    <div className="mx-2">
      ...
      <p className="my-10 text-lg text-violetmorelow">Si quieres contactarme, escríbeme a: <a href="mailto:alexbris21@gmail.com" className="text-celestelastname">alexbris21@gmail.com</a> o en <a target="_blank" className="text-celestelastname" href="https://www.linkedin.com/in/alexander-emanuel-bris-313655266/">Linkedin</a></p>
    </div>
    </section>
  );
};
